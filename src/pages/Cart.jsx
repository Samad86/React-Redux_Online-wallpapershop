          ...
          <div className="cart">
            ...
            <div className="content__items">
              <div className="cart__item">
                ...
                <div className="cart__item-info">
                  <h3>Borastapeter арт. 33557</h3>
                  <p>Основа: Бумага, 0.53 м.</p>
                </div>
              ...
              <div className="cart__item">
                ...
                <div className="cart__item-info">
                  <h3>BN International арт. 220060</h3>
                  <p>Основа: Флизелин, 0.53 м.</p>
                </div>
                <div className="cart__item-count">
                  <div className="button button--outline button--circle cart__item-count-minus">
                    <svg
              ...
              <div className="cart__item">
                ...
                <div className="cart__item-info">
                  <h3>Sandudd арт. 5259-3</h3>
                  <p>Основа: Флизелин, 1.06 м.</p>
                </div>
                <div className="cart__item-count">
                  <div className="button button--outline button--circle cart__item-count-minus">
                    <svg
              ...
              <div className="cart__item">
                ...
                <div className="cart__item-info">
                  <h3>Eco wallpaper арт. 7006</h3>
                  <p>Основа: Бумага, 0.7 м.</p>
                </div>
                <div className="cart__item-count">
                  <div className="button button--outline button--circle cart__item-count-minus">
                    <svg
            ...
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                <span>
                  {" "}
                  Всего обоев: <b>8 шт.</b>{" "}
                </span>
                <span>
                  {" "}
                  Сумма заказа: <b>9536 ₽</b>{" "}
                </span>
              </div>
