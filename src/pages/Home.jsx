      ...
      <div className="content__items">
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Borastapeter арт. 33557</h4>
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Borastapeter арт. 33501</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Eco wallpaper арт. 7018</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Andrea Rossi арт. 54118-11</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Eco wallpaper арт. 7006</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Borastapeter арт. 33542</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Decori Decori арт. 82670</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
        ...
        <div className="wallpaper-block">
          <img
            ...
            alt="Wallpaper"
          />
          <h4 className="wallpaper-block__title">Borastapeter арт. 335592</h4>
          <div className="wallpaper-block__selector">
            <ul>
              <li className="active">
                Основа:
